...
| Apple Silicon hosts | VirtualBox 7.1+ runs on macOS arm64 but cannot run x86_64 guests. | Provider is *not* auto-selected on Apple Silicon — use Fusion or Parallels instead. |
